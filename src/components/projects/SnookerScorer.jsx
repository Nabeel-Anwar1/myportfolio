...
<img src={figure1} alt="Figma design of first screen" /><br />
Figure 1 - Figma design that I was tasked with recreating in React Native.<br />

<img src={figure2} alt="Figma design of second screen" /><br />
